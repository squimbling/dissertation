...
function triggerFriendMessage() {
  ...
  addAIMMessage(
    "friend",
    "have you seen the news?? weren't you friends with a girl called isabel?",
    "jess!!"
  );
...
function unlockNewArticle() {
  ...
  newLink.innerHTML =
    '📰 Isabel Tiley — reward offered for information <span style="font-size:9px;color:#cc0000">NEW</span>';
...
function msShowHome() {
  ...
  document.getElementById("myspace-status").textContent =
...
function msShowAboutme() {
  ...
  document.getElementById("aboutme").classList.remove("invisible");
  document.getElementById("page-blog").classList.add("invisible");
  document.getElementById("page-blog").classList.remove("visible");
}

function msShowBlog() {
  document.getElementById("blog-tab").classList.add("active");
  document.getElementById("profile-tab").classList.remove("active");
  document.getElementById("page-blog").classList.add("visible");
  document.getElementById("page-blog").classList.remove("invisible");
  document.getElementById("aboutme").classList.add("invisible");
  document.getElementById("aboutme").classList.remove("visible");
}
...
function msShowProfile(who) {
  ...
  if (who === "dylan" || who === "player") {
    ...
    document.getElementById("myspace-title").textContent =
      "Dylan's Profile — MySpace";
    ...
    document.getElementById("myspace-title").textContent =
      "Isabel Tiley's Profile — MySpace";
    document.getElementById("myspace-status").textContent =
      "Viewing: Isabel Tiley";
  }
  ...
  start: {
    ...
    choices: [
      ...
      },
      {
        ...
        reply:
          "eeek sorry i know!! i haven't called in foreverrr. how are you pretty girl? xo",
    ...
    choices: [
      {
        ...
        reply:
          "not sure. can't call 2nite btw. i know we do on thu but something came up :(",
        next: "c1Dyl5",
      },
    ],
  },
